...
Ce document prépare la migration future du mode démo `localStorage` vers Supabase. Aucun paiement Stripe n'est inclus dans cette étape.
...
5. Importer les membres démo ou existants depuis `localStorage` uniquement si nécessaire.
